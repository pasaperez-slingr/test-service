package io.slingr.service.httpclone;
...
@SlingrService(name = "httpclone")
public class Httpclone extends HttpService {

    private static final String SERVICE_NAME = "httpclone";
    private static final Logger logger = LoggerFactory.getLogger(Httpclone.class);

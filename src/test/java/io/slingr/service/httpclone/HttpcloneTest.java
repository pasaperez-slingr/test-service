...
public class HttpcloneTest {

    private static final Logger logger = LoggerFactory.getLogger(HttpcloneTest.class);

    private static ServiceTests test;

    @BeforeClass
    public static void init() throws Exception {
        test = ServiceTests.start(new io.slingr.service.httpclone.Runner(), "test.properties");
    }
